...
try:
 ...
 assert bounded[0]>=-5 and bounded[1]<=50 and bounded[2]<=56 and bounded[4]<=bounded[3]+30 and bounded[5]==[],bounded
 assert bounded[6]==bounded[7] and bounded[7]>0,bounded
 print('ROAD HOP RACING AI PASS',contract,profiles,respawn,finish,bounded)
finally:d.quit()
