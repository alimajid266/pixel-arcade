...
try:
    ...
    assert flappy==['Flappy Canvas','MENU',[],'/flappy/','/zombie-defense/','/',True],flappy
    ...
    assert zombie==['Zombie Defense: Last Outpost','MENU',[],3,'/flappy/','/zombie-defense/','/',True],zombie
    ...
    assert mobile[0]<=mobile[1] and mobile[2:]==[2,[]],mobile
